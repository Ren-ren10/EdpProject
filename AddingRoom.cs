    ...
    public partial class FrmAddRoom : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT INTO Rooms (RoomNumber, RoomType, Bed, Price) VALUES (@RoomNumber, @RoomType, @Bed, @Price)";
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                FrmEditRoom editForm = new FrmEditRoom(roomNumber, roomType, price, bed, UpdateRoomInDatabase);
                editForm.ShowDialog();
                LoadRoomData();
            }
            catch (Exception ex)
